...
드디어 Next.js 13 업데이트([Blog - Next.js 13 | Next.js](https://nextjs.org/blog/next-13))가 되었다. Next 블로그의 업데이트 내용을 볼 때 마다 재밌는 이슈들이 항상 등장한다. 12 업데이트 쯤 [Blog - Layouts RFC | Next.js](https://nextjs.org/blog/layouts-rfc) 에 대한 내용이 언급되었는데 */app* 디렉토리의 베타 버전을 확인 할 수 있게 되었다. 
