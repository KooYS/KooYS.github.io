...
<Img size={80} src="1.png" caption="4개의 권한" />

이제 이 IAM 역할을 EC2에 부여. 역할 수정을 눌러 새로 만든 역할을 부여하면 된다.

<Img size={80} src="2.png" caption="역할 수정" />
...
<Img size={80} src="3.png" caption="AWSCodeDeployRole 역할" />
...
<Img size={80} src="6.png" />
<Img size={80} src="7.png" />
<Img size={80} src="8.png" />
...
<Img size={100} src="9.png"  caption="active (running) 이렇게 보인다면 성공!"/>
