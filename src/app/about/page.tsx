    ...
    <div>
      ...
      <div className="text-muted-foreground space-y-2">
        <ul className="p-4 space-y-3 text-black">
          ...
          <li className="list-disc">
            창업의 경험으로 <b>시간과 비용의 관리</b>, <b>팀워크</b>의 소중함을
            알고 있습니다.
          </li>
          <li className="list-disc">
            지식을 <b>공유</b>하며 피드백을 소중히 여겨 <b>성장</b>합니다.
          </li>
          <li className="list-disc">
      ...
      <div className="space-y-14">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            ...
            <b> 비용을 전부 절감</b>하고 <b>인력 리소스를 향상</b>시켰습니다.
          </p>
          <p className="text-muted-foreground">
            액자 판매 썸네일 생성에 소요되던 시간을 간소화하고 기획 시간을
            단축시켜 전반적인 업무 효율을 크게 향상시켰습니다. 직원들은 새로운
            백오피스 시스템을 통해 더 나은 업무 환경을 경험하게 되었습니다.
          </p>
          <Accordion type="single" collapsible>
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            이커머스 플랫폼의 기존 솔루션 의존성을 탈피하고 시장의 변화에 빠르게
            대응하고자 했습니다. 이를 위해 새로운 아키텍처를 설계하고 사용자
            요구사항을 반영한 유연한 시스템 개발을 진행했습니다.
          </p>
          <p className="text-muted-foreground">
